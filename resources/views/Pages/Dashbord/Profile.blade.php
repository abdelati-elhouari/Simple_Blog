                        ...
                        <div class="flex flex-wrap formbold--mx-3">
                          <div class="w-full sm:w-half formbold-px-3">
                            <div class="formbold-mb-5">
                              ...
                              <input type="text" name="name" id="name" placeholder="" value="{{$user->name}}" class="formbold-form-input" />
                            </div>
                          </div>
                        ...
                        <div class="flex flex-wrap formbold--mx-3">
                          <div class="w-full sm:w-half formbold-px-3">
                            <div class="formbold-mb-5">
                              ...
                              <input type="email" name="email" id="name" placeholder="" value="{{$user->email}}" class="formbold-form-input" />
                            </div>
                          </div>
                          </div>
